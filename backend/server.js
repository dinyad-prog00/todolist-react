...
mongoose.connect("mongodb+srv://<username>:<password>@cluster0.1m472.mongodb.net/<dbname>?retryWrites=true&w=majority",{ useNewUrlParser: true, useUnifiedTopology: true } );
